...
M008直接修复而非重新生成3000条教师数据，保留了生成成本并完成结构、切分、证据和分词审计。自动指标不能代替内容质量：尽管2908条证据可定位、7类配额和泄漏检查通过，600条评估记录仍未真人批准，训练集中也有1710条被标记为证据或语义风险。视频中应保留这一“机器门槛通过不等于高质量训练集”的阶段，人工验收后再进入20步SFT安全试跑。
