...
模式：`canary`；checkpoint step：`375`；质量门：**PASS**

| 指标 | Train (64) | Holdout (16) |
|---|---:|---:|
| 严格答案匹配（门控） | 64 (100.0%) | 16 (100.0%) |
| 关键点通过 | 64 (100.0%) | 16 (100.0%) |
...
| Gate | 结果 |
|---|---|
| `train_exact_answer_rate` | PASS |
| `holdout_exact_answer_rate` | PASS |
| `holdout_eos_count` | PASS |
| `per_fact_train_exact_min` | PASS |
| `per_fact_holdout_exact_min` | PASS |
...
|---|---:|---:|---:|---:|
| `fanjue_identity` | 8/8 | 2/2 | 8/8 | 2/2 |
| `xiaoyan_identity` | 8/8 | 2/2 | 8/8 | 2/2 |
| `xiaozhan_identity` | 8/8 | 2/2 | 8/8 | 2/2 |
| `yaochen_identity` | 8/8 | 2/2 | 8/8 | 2/2 |
...
| train | `xiaozhan_identity` | 萧战是萧炎的儿子吗？请纠正。 | 萧战是萧家族长，也是萧炎的父亲。 | 萧战是萧家族长，也是萧炎的父亲。 | PASS | PASS | 是 | 否 | 否 |
...
| train | `yaochen_identity` | 萧炎的老师药老原名是什么？ | 药尘就是药老，也是萧炎的老师。 | 药尘就是药老，也是萧炎的老师。 | PASS | PASS | 是 | 否 | 否 |
...
| train | `fanjue_identity` | 吞噬异火能让哪门功法进化？ | 焚决是一门能通过吞噬异火来进化的功法。 | 焚决是一门能通过吞噬异火来进化的功法。 | PASS | PASS | 是 | 否 | 否 |
...
| holdout_eval | `yaochen_identity` | 药尘在小说中通常以什么称呼出现？ | 药尘就是药老，也是萧炎的老师。 | 药尘就是药老，也是萧炎的老师。 | PASS | PASS | 是 | 否 | 否 |
...
| holdout_eval | `fanjue_identity` | 哪门功法可以借助吞噬异火不断进化？ | 焚决是一门能通过吞噬异火来进化的功法。 | 焚决是一门能通过吞噬异火来进化的功法。 | PASS | PASS | 是 | 否 | 否 |
