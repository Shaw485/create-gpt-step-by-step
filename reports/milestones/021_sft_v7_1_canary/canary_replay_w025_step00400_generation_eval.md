...
模式：`canary`；checkpoint step：`400`；质量门：**FAIL**

| 指标 | Train (64) | 未见问法 Dev/Selection (16) |
|---|---:|---:|
| 严格答案匹配（门控） | 56 (87.5%) | 11 (68.8%) |
| 关键点通过 | 59 (92.2%) | 13 (81.2%) |
...
| train | `xiaoyan_identity` | 萧炎是萧战的父亲吗？请纠正。 | 萧炎是萧战的儿子。 | 萧战是萧家族长，也是萧炎的父亲。 | FAIL | PASS | 是 | 否 | 否 |
...
| holdout_eval | `xiaoyan_identity` | 如果有人把萧炎说成萧战的父亲，应如何改正？ | 萧炎是萧战的儿子。 | 萧战是萧家族长，也是萧炎的父亲。 | FAIL | PASS | 是 | 否 | 否 |
