...
模式：`canary`；checkpoint step：`375`；质量门：**FAIL**

| 指标 | Train (64) | 未见问法 Dev/Selection (16) |
|---|---:|---:|
| 严格答案匹配（门控） | 52 (81.2%) | 10 (62.5%) |
| 关键点通过 | 54 (84.4%) | 11 (68.8%) |
...
| `xiaoyan_identity` | 4/8 | 0/2 | 6/8 | 1/2 |
| `xiaozhan_identity` | 6/8 | 2/2 | 6/8 | 2/2 |
...
| train | `yaolao_teacher` | 萧炎师从哪位人物？ | 药老是萧炎的老师。 | 萧炎是萧战的儿子。 | FAIL | FAIL | 是 | 否 | 否 |
